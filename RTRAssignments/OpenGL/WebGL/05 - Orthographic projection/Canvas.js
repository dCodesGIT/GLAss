// Orthographic projection in WebGL
// By : Darshan Vikam
// Date : 22 May 2021
...
function resize() {
	...
	if(canvas.width <= canvas.height)
		mat4.ortho(orthoProjMatrix, -100.0, 100.0, (-100.0 * (canvas.height / canvas.width)), (100 * (canvas.height / canvas.width)), -100.0, 100.0);
	else
		mat4.ortho(orthoProjMatrix, (-100.0 * (canvas.height / canvas.width)), (100 * (canvas.height / canvas.width)), -100.0, 100.0, -100.0, 100.0);
}
...
function display() {
	...
	mat4.multiply(ModelViewProjectionMatrix, orthoProjMatrix, ModelViewMatrix);
