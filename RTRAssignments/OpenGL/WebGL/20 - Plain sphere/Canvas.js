...
var sphereVertices, sphereColor;
...
function initialize() {
	...
	sphereColor = getSphereColors(sphereVertices.length, 1.0, 1.0, 1.0);
	...
	gl.bindVertexArray(VAObj);
		...
		gl.bufferData(gl.ARRAY_BUFFER, sphereColor, gl.STATIC_DRAW);
