...
function display() {
	...
	pushMatrix(mat4.clone(MMatrix));
		...
		mat4.rotate(RotationMatrix, RotationMatrix, year * radians, [0.0, 1.0, 0.0]);
		mat4.multiply(MMatrix, MMatrix, RotationMatrix);
		TranslationMatrix = mat4.create();
		mat4.translate(TranslationMatrix, TranslationMatrix, [4.0, 0.0, 0.0]);
		mat4.multiply(MMatrix, MMatrix, TranslationMatrix);
		RotationMatrix = mat4.create();
		mat4.rotate(RotationMatrix, RotationMatrix, day * radians, [0.0, 1.0, 0.0]);
		mat4.multiply(MMatrix, MMatrix, RotationMatrix);
		...
		gl.uniformMatrix4fv(VMatrixUniform, false, VMatrix);
		gl.uniformMatrix4fv(PMatrixUniform, false, PMatrix);
		gl.uniform3f(ColorUniform, 0.4, 0.9, 1.0);
		gl.bindVertexArray(VAObj);
			gl.drawArrays(gl.TRIANGLES, 0, sphereVertices.length);
		gl.bindVertexArray(null);
	gl.useProgram(null);
