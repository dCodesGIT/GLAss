// 3D Shapes with textures in WebGL
// By : Darshan Vikam
// Date : 06 July 2021
...
var stone_texture, kundali_texture;
...
function initialize() {
	...
	const pyramidTexCoords = new Float32Array([
		// Front face - Apex, left bottom, right bottom
	...
	stone_texture = loadTexture(gl, "stone.png");
	kundali_texture = loadTexture(gl, "kundali.png");
