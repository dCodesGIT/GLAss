package com.rtr3_android.multipleViewport;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
	...
	private int[] VBObj = new int[2];	// [0]-Position, [1]-Color
	private int MVPUniform;

	private float perspProjMatrix[] = new float[16];	// 4x4 matrix

	private int tapCounter = 0;
	private int w, h, vp_x, vp_y;
	...
	private void initialize(GL10 gl) {
		...
		GLES32.glBindVertexArray(VAObj[0]);
			GLES32.glGenBuffers(2, VBObj, 0);
			GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, VBObj[0]);		// Vertices of triangle
			...
			GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, VBObj[1]);		// Color of triangle
		...
		//	GLES32.glVertexAttrib3fv(GLESMacros.DV_ATTRIB_COLOR, triangleColor, 0);
	...
	private void Uninitialize() {
		...
		if(VBObj[0] != 0) {
			GLES32.glDeleteBuffers(2, VBObj, 0);
			VBObj[0] = 0;
			VBObj[1] = 0;
		}
