// To display Concentric Rectangle
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	HWND hwnd;
	MSG msg;
	TCHAR szAppName[] = TEXT("ConcentricRectangle");
	int hCentre, vCentre;
	bool bDone = false;
	...
	// Create Window
	hwnd = CreateWindow(szAppName, TEXT("Concentric Rectangle"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, hCentre - (WIN_WIDTH / 2), vCentre - (WIN_HEIGHT / 2), WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
...
void Display() {
	...
	glBegin(GL_LINES);
	for(i=1.0f, color=1; i>0.0f; i-=0.1f, color++) {
		switch(color) {
			case 1 :
