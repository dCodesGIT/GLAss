// To display spinning pyramid and all axis rotating cube with applied texture
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	HWND hwnd;
	MSG msg;
	TCHAR szAppName[] = TEXT("Multiple3DShapesWithTexture");
	int hCentre, vCentre;
	bool bDone = false;
	...
	// Create Window
	hwnd = CreateWindow(szAppName, TEXT("Multiple 3D shapes with Textures"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, hCentre - (WIN_WIDTH / 2), vCentre - (WIN_HEIGHT / 2), WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
...
void Display() {
	...
	//glColor3f(1.0f, 0.0f, 0.0f);		// Front triangle
	...
	//glColor3f(1.0f, 0.0f, 0.0f);		// Right triangle
	glTexCoord2f(0.5f, 1.0f);
	glVertex3f(0.0f, 2.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f);
	glVertex3f(1.0f, -1.0f, -1.0f);
	...
	//glColor3f(1.0f, 0.0f, 0.0f);		// Back triangle
	glTexCoord2f(0.5f, 1.0f);
	glVertex3f(0.0f, 2.0f, 0.0f);
	glTexCoord2f(1.0f, 0.0f);
	glVertex3f(-1.0f, -1.0f, -1.0f);
	...
	//glColor3f(1.0f, 0.0f, 0.0f);		// Left triangle
	glTexCoord2f(0.5f, 1.0f);
	glVertex3f(0.0f, 2.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f);
	glVertex3f(-1.0f, -1.0f, 1.0f);
