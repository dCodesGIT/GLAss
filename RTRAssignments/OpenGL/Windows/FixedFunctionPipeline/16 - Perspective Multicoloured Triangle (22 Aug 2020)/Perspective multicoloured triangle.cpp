// Perspective multicoloured triangle
// Date : 22 August 2020
// By : Darshan Vikam
...
#include "WinIcon.h"
#include <gl/GL.h>
#include <gl/glu.h>	// graphic library utility header file
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	// Create Window call
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("Multicoloured triangle using OpenGL"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, hCentre - (WIN_WIDTH / 2), vCentre - (WIN_HEIGHT / 2), WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
	ghwnd = hwnd;
