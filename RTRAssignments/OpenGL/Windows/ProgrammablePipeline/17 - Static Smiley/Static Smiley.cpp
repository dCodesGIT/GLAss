// Program to show static smiley on a simple square
// By : Darshan Vikam
// Date : 27 March 2021
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	HWND hwnd;
	MSG msg;
	TCHAR szAppName[] = TEXT("StaticSmileyInPP");
	bool bDone = false;
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("Static Smiley"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, 100, 100, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
	ghwnd = hwnd;
...
void Initialize(void) {
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(SquareTexture), SquareTexture, GL_STATIC_DRAW);		// Placing values in OpenGL's shader buffer(GL_VERTEX_BUFFER)
