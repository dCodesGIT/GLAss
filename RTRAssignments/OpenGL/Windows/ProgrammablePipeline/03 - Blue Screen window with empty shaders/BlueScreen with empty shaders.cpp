// Program to look at placement of shaders and code related to enabling shaders
// By : Darshan Vikam
// Date : 4 March 2021
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	HWND hwnd;
	MSG msg;
	TCHAR szAppName[] = TEXT("BlueScreenWindowWithEmptyShaders");
	bool bDone = false;
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("Blue Screen window with empty shaders"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, 100, 100, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
	ghwnd = hwnd;
...
void Initialize(void) {
	...
	// Vertex Shader
	gVertexShaderObject = glCreateShader(GL_VERTEX_SHADER);		// Create shader
	const GLchar *vertexShaderSourceCode = 				// Source code of shader
		"#version 450" \
		"\n" \
		"void main(void)" \
		"{" \
	...
	glCompileShader(gVertexShaderObject);				// Compile Shader
...
void Uninitialize(void) {
	...
	glDeleteProgram(gShaderProgramObject);		// Delete final shader program
