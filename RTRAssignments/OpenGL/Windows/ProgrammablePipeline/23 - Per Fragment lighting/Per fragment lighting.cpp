// Program to show 3D Sphere with Per fragment lighting
// By : Darshan Vikam
// Date : 06 April 2021
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	HWND hwnd;
	MSG msg;
	TCHAR szAppName[] = TEXT("PerFragmentLightingInPP");
	bool bDone = false;
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("Per Fragment Lighting"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, 100, 100, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
	ghwnd = hwnd;
...
void Display(void) {
	...
	*/}
	if(gbEnableLighting == true) {
		...
		glUniform1f(gMaterialShininessUniform, 128);
	}
	else
