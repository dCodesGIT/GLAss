// Spinning Multicoloured triangle at different Viewport() in XWindows
...
void CreateWindow(void) {
	...
	XStoreName(gpDisplay, gWindow, "Spinning triangle with Viewport()");
