// 3D pyramid with stone texture in XWindows
...
GLuint texture_stone;		// Variable to store texture reference 
...
void CreateWindow(void) {
	...
	XStoreName(gpDisplay, gWindow, "3D Pyramid with texture");
...
void Initialize(void) {
	...
	// Loading textures
	texture_stone = LoadBitmapAsTexture("stone.png");
