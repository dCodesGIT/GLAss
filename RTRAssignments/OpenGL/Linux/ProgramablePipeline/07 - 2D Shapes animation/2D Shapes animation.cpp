// 2D shapes animated - spinning triangle and rolling quad in XWindows in Programmable Pipeline
// Date : 14 April 2021
// By : Darshan Vikam
...
GLuint gVAObj_shapes[2];	// Vertex Array Object - [0]-triangle; [1]-square
GLuint gVBObj_triangle[2];	// Vertex Buffer Object - for triangle
GLuint gVBObj_square[2];	// Vertex Buffer Object - for square
...
void CreateWindow(void) {
	...
	XStoreName(gpDisplay, gWindow, "2D shapes animation");
...
//	ShaderErrorCheck(gSPObj, "LINK");
	...
	*/	0.0f, 1.0f, 0.0		// Top right
	};

	glGenVertexArrays(2, gVAObj_shapes);
...
void Uninitialize() {
	...
	if(gVAObj_shapes) {
		glDeleteVertexArrays(2, gVAObj_shapes);
		gVAObj_shapes[0] = 0;
		gVAObj_shapes[1] = 0;
	}
