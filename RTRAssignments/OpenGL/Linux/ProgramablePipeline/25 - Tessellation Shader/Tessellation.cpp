// Tessellation of bezier curve in XWindows in Programmable Pipeline
// Date : 26 June 2021
// By : Darshan Vikam
...
GLuint gVBObj;		// Vertex Buffer Object
...
mat4 gPerspProjMatrix;	// 4x4 matrix for orthographic projection
...
void CreateWindow(void) {
	...
	XStoreName(gpDisplay, gWindow, "Tessellation");
...
void Initialize(void) {
	...
	ShaderErrorCheck(gTCSObj, (char *)"TESS_CONTROL");
	...
	ShaderErrorCheck(gTESObj, (char *)"TESS_EVALUATION");
	...
	ShaderErrorCheck(gVSObj, (char *)"FRAGMENT");
