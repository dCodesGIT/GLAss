// Goemetry shader in XWindows in Programmable Pipeline
// Date : 26 June 2021
// By : Darshan Vikam
...
void CreateWindow(void) {
	...
	XStoreName(gpDisplay, gWindow, "Geometry");
...
void Initialize(void) {
	...
	// Geomtry Shader
	gGSObj = glCreateShader(GL_GEOMETRY_SHADER);
	const GLchar *GSSrcCode =
		"#version 450 core \n" \
		"layout(triangles)in;" \
	...
	glCompileShader(gGSObj);
	ShaderErrorCheck(gGSObj, (char *)"GEOMETRY");
