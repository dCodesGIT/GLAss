// To demonstrate a structure - Method 1 - multiple structures
// Date : 12 June 2020
// By : Darshan Vikam
...
struct coordinates {
	int x, y;
}point;				// Global structure variable declaration

struct coordinateProperties {
	int quadrant;
	char axis_location[10];
}pointProperties;		// Global structure variable declaration
